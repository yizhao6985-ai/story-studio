...
import { deleteWorkThread } from "../agent/runtime/work-graph.js";
import type { ConversationManifest } from "../../src/lib/story/types.js";
import {
  normalizeWorkPath,
...
async function readConversationIndex(workPath: string): Promise<ConversationManifest[]> {
  try {
...
export async function listConversations(workPath: string): Promise<ConversationManifest[]> {
...
export async function deleteConversation(
  ...
  await deleteWorkThread(workPath, conversationId);
  return true;
}
